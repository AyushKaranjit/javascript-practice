...
let myIncomeInNpr = 15000;
let myIncomeInDollar = myIncomeInNpr / 150;
let myTaxRate = 0.1;
let myTaxes = myIncomeInDollar * myTaxRate;
console.log(myTaxes);
console.log(myIncomeInDollar);
console.log(myIncomeInNpr);
console.log(myTaxRate);
